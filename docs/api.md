...
This library allows to use any Arduino-compatible board with an PD243x I^2C Display Adapter Board. It should work as long as `Wire` library and C++ compiler is avarible for a particular Arduino platform.
...
#### Parameters
`uint8_t attribute`: Attribute to set. 
Possible options:
